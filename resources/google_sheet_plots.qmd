...
- You can customize particular colors by going to Cusotmize $\rightarrow$ Series and then selecting a particular category from the first dropdown. You can then edit how that is displayed.
