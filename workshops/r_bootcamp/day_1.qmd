...
- Able to load data in and calculate useful statistics with it. 
    - Difference of means and linear regression. 
...
1
_variable <- 2 # variables cannot start with a number though
```
...
# yours will look something like C:/users/reunink/Downloads
# or ~/Downloads
